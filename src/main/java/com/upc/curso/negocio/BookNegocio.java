...
public class BookNegocio {
    ...
    public List<Book> listBooksAuthor(Long id){
        return bookRepositorio.findAllByAuthor_Id(id);
    }
    public int quantityBooks(Long id){
        return bookRepositorio.quantityBooks(id);
    }
